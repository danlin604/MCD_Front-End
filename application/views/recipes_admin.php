<tbody>
  <tr>
    ...
    <td class="mdl-data-table__cell--non-numeric">{meat_patty}</td>
    <td class="mdl-data-table__cell--non-numeric">{mac_sauce}</td>
    <td class="mdl-data-table__cell--non-numeric">{fish_patty}</td>
    <td class="mdl-data-table__cell--non-numeric">{fries}</td>
    <td class="mdl-data-table__cell--non-numeric">{soft_drink}</td>    
  </tr>
</tbody>